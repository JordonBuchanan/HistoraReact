...
class NewPost extends Component {
  ...
  render() {
    return (
      <Wrapper>
        <Button data-target="modal1">NEW POST</Button>
        <ModalWrapper
          ref={Modal => {
            this.Modal = Modal;
          }}
            ...
            <Formik
              ...
              onSubmit={(values, { setSubmitting, resetForm }) => {
                ...
                setTimeout(() => {
                  ...
                  instance.close();
                  resetForm();
                  window.flash('Post created successfully!', 'success')
                }, 400);
              }}
            >
              {({ errors, touched, isSubmitting }) => (
                <Form>
                  <div>
                    ...
                    <Field type="text" name="title" className={(errors.title && touched.title ? ' is-invalid' : '')}/>
